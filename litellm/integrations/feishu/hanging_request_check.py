...
class AlertingHangingRequestCheck:
    ...
    def __init__(
        self,
        feishu_alerting_object: FeishuAlerting,
    ):
    ...
    async def send_hanging_request_alert(
        ...
        """
        # Correct import path for AlertType
...
Team Alias: `{hanging_request_data.team_alias}`"""
        ...
        await self.feishu_alerting_object.send_alert(
            ...
            template_params={
                "threshold_seconds": float(self.feishu_alerting_object.alerting_threshold),
                "model": hanging_request_data.model,
                "api_base": hanging_request_data.api_base,
                "key_alias": hanging_request_data.key_alias,
                "team_alias": hanging_request_data.team_alias,
